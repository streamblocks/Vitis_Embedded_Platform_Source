# Vitis Base DFX Platform for the ZCU106 Board for StreamBlocks

A basic platform targeting the ZCU106 evaluation board, which includes 4GB of DDR4 for the Processing System, GEM, USB, SDIO card interface and UART of the Processing system. It reserves most of the PL resources for user to add acceleration kernels. This platform also demonstrates (Dynamic Function eXchange) capabilites of the Xilinx FPGAs
...
By default this Makefile will install the platform to "platform_repo/xilinx_zcu106_base_dfx_202010_1/export/xilinx_zcu106_base_dfx_202010_1/"
...
#example:
make petalinux_proj XSA_DIR=/home/user/zcu106_base_dfx/vivado
make pfm XSA_DIR=/home/user/zcu106_base_dfx/vivado
```
...
```bash
make petalinux_proj XSA_DIR=/home/user/zcu106_base_dfx/vivado COMMON_RFS_KRNL_SYSROOT=FALSE
make pfm /home/user/zcu106_base_dfx/vivado COMMON_RFS_KRNL_SYSROOT=FALSE
```
...
| Type              | Value                           |
| ----------------- | ---------------------------     |
| Release Version   | xilinx_zcu106_base_dfx_202010_1 |
...
The software configurations are based on [ZCU106 BSP](https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/embedded-design-tools.html). Here is the list of additional configurations.
