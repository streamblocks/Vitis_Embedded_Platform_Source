...
set projName "xilinx_zcu106_dynamic_0_1"
set projPart "xczu7ev-ffvc1156-2-e"
set projBoardPart "xilinx.com:zcu106:part0:2.5"
...
set_property platform.board_id                      "zcu106"    [current_project]
set_property platform.name                          "dynamic"    [current_project]
set_property platform.version                       "1.0"        [current_project]
set_property platform.description                   "This platform targets the ZCU106 Development Board for StreamBlocks. This platform features one PL and one PS channels of DDR4 SDRAM which are instantiated as required by the user kernels for high fabric resource availability ." [current_project]
