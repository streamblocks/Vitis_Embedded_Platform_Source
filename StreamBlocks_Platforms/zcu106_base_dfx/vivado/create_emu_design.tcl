...
set_property dsa.board_id                      "ZCU106"    [current_project]
set_property dsa.name                          "dynamic"    [current_project]
set_property dsa.version                       "0.1"        [current_project]
set_property dsa.description                   "This platform targets the ZCU106 Development Board. This platform features one PL and one PS channels of DDR4 SDRAM which are instantiated as required by the user kernels for high fabric resource availability ." [current_project]
