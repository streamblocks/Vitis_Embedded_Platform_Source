...
proc create_root_design { parentCell } {
  ...
  set clkwiz_kernel3_clk_out [ create_bd_port -dir I -type clk -freq_hz 99990000 clkwiz_kernel3_clk_out ]
  set clkwiz_kernel4_clk_out [ create_bd_port -dir I -type clk -freq_hz 199980000 clkwiz_kernel4_clk_out ]
  set clkwiz_kernel5_clk_out [ create_bd_port -dir I -type clk -freq_hz 399960000 clkwiz_kernel5_clk_out ]
  set clkwiz_kernel6_clk_out [ create_bd_port -dir I -type clk -freq_hz 599940000 clkwiz_kernel6_clk_out ]
  set clkwiz_kernel_clk_out1 [ create_bd_port -dir I -type clk clkwiz_kernel_clk_out1 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {149985000} \
