...
################################################################
# This is a generated script based on design: zcu106_base
#
...
if { $list_projs eq "" } {
   create_project zcu106_base zcu106_base -part xczu7ev-ffvc1156-2-e
...
set_property SELECTED_SIM_MODEL tlm [get_bd_cells /ps_e]
  ...
  set_property PFM_NAME {xilinx:zcu106:zcu106_base:1.0} [get_files [current_bd_design].bd]
...
generate_target  all  [get_files  ./zcu106_base/zcu106_base.srcs/sources_1/bd/zcu106_base/zcu106_base.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./zcu106_base/zcu106_base.srcs/sources_1/bd/zcu106_base/zcu106_base.bd] -top
add_files -norecurse ./zcu106_base/zcu106_base.srcs/sources_1/bd/zcu106_base/hdl/zcu106_base_wrapper.v
...
file mkdir ./zcu106_base/zcu106_base.sdk
write_hwdef -force  -file ./zcu106_base/zcu106_base.sdk/zcu106_base_wrapper.hdf

#set_property platform.post_sys_link_tcl_hook ./dynamic_postlink.tcl [current_project]

write_hw_platform -unified -include_bit ./xilinx_zcu106_base_202010_1.xsa
#write_hw_platform -force  ././xilinx_zcu106_base_202010_1.xsa

validate_hw_platform ./xilinx_zcu106_base_202010_1.xsa
