...
platform -name $platform_name -desc "A basic static platform targeting the ZCU106 evaluation board, which includes 4GB DDR4, GEM, USB, SDIO interface and UART of the Processing System. It reserves most of the PL resources for user to add acceleration kernels" -hw $xsa_path/$platform_name.xsa -out $output_path -no-boot-bsp
