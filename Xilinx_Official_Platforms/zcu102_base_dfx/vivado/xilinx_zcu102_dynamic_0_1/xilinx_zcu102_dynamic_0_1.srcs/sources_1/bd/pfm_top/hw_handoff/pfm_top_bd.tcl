...
proc create_hier_cell_pr_isolation_expanded { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_pr_isolation_expanded() - Empty argument(s)!"}
     return
  }
  ...
  set regslice_data_periph_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 regslice_data_periph_1 ]
  set_property -dict [ list \
  ...
  set regslice_ddrmem_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 regslice_ddrmem_2 ]

  # Create instance: regslice_ddrmem_3, and set properties
  set regslice_ddrmem_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 regslice_ddrmem_3 ]
...
proc create_hier_cell_static_region { parentCell nameHier } {
  ...
  set axi_interconnect_mgmt [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_mgmt ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $axi_interconnect_mgmt

  # Create instance: axi_interconnect_user, and set properties
  set axi_interconnect_user [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_user ]
  set_property -dict [ list \
   CONFIG.NUM_MI {3} \
  ...
  set axi_vip_data_m00_axi_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vip:1.1 axi_vip_data_m00_axi_1 ]
  ...
  set debug_bridge_xvc [ create_bd_cell -type ip -vlnv xilinx.com:ip:debug_bridge:3.0 debug_bridge_xvc ]
  set_property -dict [ list \
