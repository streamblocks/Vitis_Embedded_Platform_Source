...
create_clock -period 50 [get_pins -filter {REF_PIN_NAME=~INTERNAL_TCK} -of_objects [get_cells -hierarchical -filter {NAME =~ "*BSCAN_SWITCH.N_EXT_BSCAN.bscan_inst/SERIES7_BSCAN.bscan_inst"}]]
